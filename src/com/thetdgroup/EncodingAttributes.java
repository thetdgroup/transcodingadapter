...
public class EncodingAttributes implements Serializable
{
	 ...
	 * the source stream, starting from the offset, will be completely re-encoded
	 ...
	 * multimedia file. If null of not specified no audio stream will be encoded.
	 * It cannot be null if also the video field is null.
	 * 
	 ...
	 * multimedia file. If null of not specified no video stream will be encoded.
	 * It cannot be null if also the audio field is null.
	 * 
	...
	{
	return getClass().getName() + "(format=" + format + ", offset=" + offset
			+ ", duration=" + duration + ", audioAttributes=" + audioAttributes
