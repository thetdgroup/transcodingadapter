...
public class Encoder
{
	 ...
	 * encoding operation.
	 */
	private static final Pattern SUCCESS_PATTERN = Pattern.compile("^\\s*video\\:\\S+\\s+audio\\:\\S+\\s+global headers\\:\\S+.*$",
	 ...
	 * 
	 * @param locator
	 *         The locator picking up the ffmpeg executable used by the encoder.
	 */
	 ...
	 *          If the format of the source file cannot be recognized and decoded.
	 * @throws EncoderException
	 *          If a problem occurs calling the underlying ffmpeg executable.
	 */
	...
	/**
	 * Private utility. It parses the ffmpeg output, extracting informations about
	 * a source multimedia file.
	 * 
	 * @param source
	 *         The source multimedia file.
	 * @param reader
	 ...
	 * 
	 * @param source
	 *         The source multimedia file. It cannot be null. Be sure this file can
	 *         be decoded (see {@link Encoder#getSupportedDecodingFormats()},
	 *         {@link Encoder#getAudioDecoders()} and
	 *         {@link Encoder#getVideoDecoders()}).
	 * @param target
	 *         The target multimedia re-encoded file. It cannot be null. If this
	 ...
	 *         A set of attributes for the encoding process.
	 * @param listener
	 *         An optional progress listener for the encoding process. It can be
	 *         null.
	 * @throws IllegalArgumentException
	 *          If both audio and video parameters are null.
	 * @throws InputFormatException
